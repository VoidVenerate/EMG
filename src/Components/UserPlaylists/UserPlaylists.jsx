...
const UserPlaylists = () => {
  ...
  const handlePlaylistClick = (playlist, e) => {
    // Don't navigate if clicking on the open playlist button
    if (e.target.closest('.open-playlist-btn')) {
      return
    }
  ...
  return (
    <div className="playlists-page" style={{marginLeft:'0px'}}>
            ...
            : currentPlaylists.map((playlist) => (
                ...
                >
                  <div className="playlist-image-wrapper">
                    ...
                    {/* Bottom overlay with spotify and barcode */}
